    ...
    <footer className="border-t border-white/5 py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            <a href="#" className="flex items-center gap-2 mb-4">
              <span className="font-heading text-xl font-bold text-white flex items-center gap-1">
                <span className="gradient-text">otomo</span>AI
              </span>
            </a>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li><a href="#compare" className="hover:text-gray-300 transition">Comparison</a></li>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-600">© 2026 otomoAI. All rights reserved.</p>
