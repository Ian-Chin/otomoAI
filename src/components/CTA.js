      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <FadeUp>
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
            Ready to Put Your Workshop {' '}<span className="gradient-text">On Autopilot?</span>
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <a href="#" className="btn-primary cta-glow text-base sm:text-lg group">
              Book a Free Demo
              <span className="inline-block ml-1 transition-transform duration-300 group-hover:translate-x-1">→</span>
            </a>
            <a href="#" className="btn-secondary text-base sm:text-lg">
              Contact Sales
            </a>
          </div>
