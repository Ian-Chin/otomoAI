...
const problems = [
  {
    ...
    iconBg: 'bg-brand-600/10 ring-1 ring-brand-600/20',
  ...
  {
    icon: (
      <svg className="w-6 h-6 text-fire-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
      </svg>
    ),
    iconBg: 'bg-fire-500/10 ring-1 ring-fire-500/20',
        ...
        <div className="grid md:grid-cols-3 gap-6 stagger-children">
          {problems.map((p) => (
            <FadeUp key={p.title} className="glass rounded-2xl p-8 card-hover group">
              ...
              <p className="text-gray-400 leading-relaxed text-[15px]">{p.desc}</p>
            </FadeUp>
          ))}
        </div>
      </div>
