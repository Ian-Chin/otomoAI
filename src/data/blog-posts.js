...
const blogPosts = [
  ...
  {
    slug: 'ai-modification-visualizer-how-it-works',
    title: 'AI Modification Visualizer: How It Works and Why Customers Buy More',
    excerpt:
      'An inside look at how AI-generated vehicle modification previews help workshops increase their average ticket size by making upgrades tangible before purchase.',
    cover: 'https://images.unsplash.com/photo-1619405399517-d7fce0f13302?w=1200&h=630&fit=crop&q=80',
    coverAlt: 'Modified sports car with custom bodykit in a workshop',
    category: 'AI & Technology',
    categoryColor: 'text-purple-400 bg-purple-500/10 ring-1 ring-purple-500/20',
    date: '2026-02-18',
    readTime: '8 min read',
    ...
    content: [
      {
        type: 'paragraph',
        text: 'Selling vehicle modifications has always had a visualisation problem. A customer walks in wanting a bodykit for their Civic. The advisor pulls up a few Instagram photos of similar builds and tries to describe how the kit would look on the customer\'s specific colour and model year. The customer cannot picture it, feels uncertain about spending RM 5,000–RM 15,000, and says "let me think about it." They rarely come back.',
      },
      {
        type: 'paragraph',
        text: 'otomoAI\'s modification visualiser uses generative AI to solve this. The customer takes a photo of their vehicle in the workshop. The AI renders a realistic preview of the proposed modifications — bodykit, wheels, paint, exhaust tips, lowering springs — on their actual car. Not a generic stock photo. Their car, in their colour, from the angle they photographed it.',
      },
      {
        type: 'image',
        src: 'https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?w=800&h=450&fit=crop&q=80',
        alt: 'Modified sports car with aftermarket bodykit and custom wheels',
        caption: 'Fig. 1 — AI-generated previews show customers exactly how modifications will look on their specific vehicle.',
      },
      {
        type: 'heading',
      ...
      {
        type: 'paragraph',
        text: 'The system uses a multi-stage pipeline built on Google\'s Gemini vision models. Stage one: the uploaded photo is analysed to identify the vehicle\'s make, model, colour, angle, and lighting conditions. Stage two: the requested modification is mapped to a reference library of aftermarket parts (bodykits, wheels, spoilers, etc.) with accurate dimensional data. Stage three: the AI composites the modification onto the original photo, matching perspective, lighting, shadows, and reflections.',
      },
      {
        type: 'paragraph',
        text: 'The entire process takes 15–30 seconds per modification. A customer can see three different bodykit options on their car within two minutes. Compare this to the traditional approach of scrolling through Instagram or waiting days for a Photoshop mockup.',
      },
      {
        type: 'image',
        src: 'https://images.unsplash.com/photo-1581092162384-8987c1d64718?w=800&h=450&fit=crop&q=80',
        alt: 'Person using a tablet to view vehicle customization options',
        caption: 'Fig. 2 — Customers can compare multiple modification options on their own vehicle in under two minutes.',
      },
      {
        type: 'heading',
        text: 'Beyond Visuals: Pros, Cons, and Cost Transparency',
      },
      {
        type: 'paragraph',
        text: 'The visualiser does not just show what the modification looks like. It generates a detailed breakdown for each option: estimated cost range, installation time, impact on warranty, legal compliance (important in markets with strict modification regulations), and potential effects on vehicle performance or fuel economy.',
      },
      {
        type: 'paragraph',
        text: 'This transparency builds trust. When a customer can see that a specific bodykit costs RM 8,500 installed, takes 2 days, and has no impact on their warranty, they can make an informed decision. Workshops report that this informed confidence significantly reduces the "let me think about it" response.',
      },
      {
        type: 'heading',
        text: 'Revenue Impact: Data from Early Adopters',
      },
      {
        type: 'paragraph',
        text: 'Eight workshops in our pilot programme used the modification visualiser for three months. Average ticket size for modification jobs increased by 47%. Modification enquiry-to-purchase conversion rate went from 23% to 58%. Two workshops reported that the visualiser opened entirely new revenue streams — customers who came in for routine servicing saw the visualiser demo in the waiting area and enquired about modifications they had not previously considered.',
      },
      {
        type: 'image',
        src: 'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=800&h=450&fit=crop&q=80',
        alt: 'Premium car workshop showroom with modified vehicles on display',
        caption: 'Fig. 3 — Early adopters reported a 47% increase in average ticket size for modification jobs.',
      },
      {
        type: 'heading',
        text: 'Limitations and Honest Expectations',
      },
      {
        type: 'paragraph',
        text: 'The technology is not perfect. Renderings work best with well-lit, side-angle photos against clean backgrounds. Dark parking garage shots or heavily obstructed angles produce lower-quality results. The AI occasionally struggles with very new or very rare vehicles that have limited training data. We are transparent about these limitations because setting accurate expectations is more important than overselling capabilities.',
      },
    ],
  },
  {
